...
(function () {
  ...
  // ---------- Roles: featured preview <-> full chronological list ----------
  function initCredits() {
    var toggle = document.getElementById("credits-toggle");
    var featured = document.getElementById("roles-featured");
    var full = document.getElementById("roles-full");
    if (!toggle || !featured || !full) return;

    toggle.addEventListener("click", function () {
      var showFull = toggle.getAttribute("aria-expanded") !== "true";
      toggle.setAttribute("aria-expanded", String(showFull));
      featured.hidden = showFull;
